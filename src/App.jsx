        ...
        <div className="p-6">
          {step === 'details' && (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full p-3 rounded-xl border border-slate-200  bg-slate-50  text-slate-800  placeholder:text-slate-400  focus:outline-none focus:ring-2 focus:ring-orange-200  focus:border-orange-400  transition-all"
                    value={formData.name}
                ...
                <div>
                  ...
                  <div className="relative">
                    <input 
                      ...
                      className={`w-full p-3 rounded-xl border bg-slate-50  text-slate-800  placeholder:text-slate-400  focus:outline-none focus:ring-2 transition-all ${
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      maxLength="19"
                      className="w-full pl-10 pr-3 py-3 rounded-xl border border-slate-200  bg-slate-50  text-slate-800  placeholder:text-slate-400  focus:outline-none focus:ring-2 focus:ring-orange-200  focus:border-orange-400  transition-all font-mono text-sm"
                      value={formData.card}
              ...
              <button type="submit" className="w-full mt-6 py-4 bg-orange-500 text-white rounded-xl font-bold hover:bg-orange-600 transition-all shadow-lg flex justify-center items-center gap-2">
  ...
  return (
    <>
      ...
      <GlassCard className="flex flex-col gap-4 group relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-white/95  backdrop-blur-xl z-20 flex flex-col justify-center items-center p-6 text-slate-800  animate-in fade-in zoom-in-95 duration-200">
              ...
              <form onSubmit={initiateCustomBid} className="w-full flex gap-2 mb-4">
                   ...
                   <button 
                      ...
                      className="px-4 py-2 bg-orange-500 disabled:bg-slate-300 text-white rounded-xl font-bold hover:bg-orange-600 transition-colors"
                   >
                     <ArrowRight size={20} />
                   </button>
              </form>
        ...
        <div className="h-56 w-full bg-white  rounded-2xl overflow-hidden relative shadow-sm p-4">
            <img 
              src={img} 
              alt={title} 
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white  overflow-x-hidden font-sans selection:bg-orange-200  selection:text-orange-900  text-slate-800  relative transition-colors duration-200">
      ...
      <section className="relative pt-32 md:pt-40 pb-8 px-6">
      ...
      <section id="auction" className="pt-4 pb-16 px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-slate-800  font-display flex items-center gap-2 mb-3">
            Auction Items
          </h2>
